<?php /* Smarty version 2.6.11, created on 2011-04-06 08:47:32
...
>
					        ...
					        <td width="35%" >
							<select id="mail_smtpssl" name="mail_smtpssl" tabindex="501"><?php echo $this->_tpl_vars['MAIL_SSL_OPTIONS']; ?>
</select>
					        </td>
						</tr>
						<tr id="smtp_auth1">
...
" tabindex='1' ></td>
                       ...
                       <tr id="smtp_auth2">
                            ...
                            <td width="30%" ><input type="password" id="mail_smtppass" name="mail_smtppass" size="25" maxlength="64" value="<?php echo $this->_tpl_vars['mail_smtppass']; ?>
" tabindex='1'></td>
                            <td width="20%">&nbsp;</td>
                            <td width="30%">&nbsp;</td>
                       </tr>
