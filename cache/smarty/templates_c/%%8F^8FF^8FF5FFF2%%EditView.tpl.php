...
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_KEY']; ?>
" class="button" onclick="window.location.href='index.php?action=index&module=Cases'; return false;" type="button" name="button" value="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_NUMBER','module' => 'Cases'), $this);?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACTNAME','module' => 'Cases'), $this);?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACTPHONE','module' => 'Cases'), $this);?>
...
<?php if (strlen ( $this->_tpl_vars['fields']['contactphone_c']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['contactphone_c']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['contactphone_c']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['contactphone_c']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['contactphone_c']['name']; ?>
' size='30' 
maxlength='255' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title='' tabindex='105' > 
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_JOBNUMBER','module' => 'Cases'), $this);?>
...
<?php if (strlen ( $this->_tpl_vars['fields']['jobnumber_c']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['jobnumber_c']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['jobnumber_c']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['jobnumber_c']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['jobnumber_c']['name']; ?>
' size='30' 
maxlength='255' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title='' tabindex='106' > 
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_WORKGROUP','module' => 'Cases'), $this);?>
...
<script type="text/javascript">
addToValidate(\'EditView\', \'id\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ID','module' => 'Cases'), $this); echo '\' );
addToValidate(\'EditView\', \'name\', \'name\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SUBJECT','module' => 'Cases'), $this); echo '\' );
addToValidate(\'EditView\', \'date_entered_date\', \'date\', false,\'Date Created\' );
addToValidate(\'EditView\', \'date_modified_date\', \'date\', false,\'Date Modified\' );
addToValidate(\'EditView\', \'modified_user_id\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED','module' => 'Cases'), $this); echo '\' );
addToValidate(\'EditView\', \'modified_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED_NAME','module' => 'Cases'), $this); echo '\' );
addToValidate(\'EditView\', \'created_by\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'Cases'), $this); echo '\' );
addToValidate(\'EditView\', \'created_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'Cases'), $this); echo '\' );
addToValidate(\'EditView\', \'description\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'Cases'), $this); echo '\' );
addToValidate(\'EditView\', \'deleted\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DELETED','module' => 'Cases'), $this); echo '\' );
addToValidate(\'EditView\', \'assigned_user_id\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_ID','module' => 'Cases'), $this); echo '\' );
addToValidate(\'EditView\', \'assigned_user_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'Cases'), $this); echo '\' );
addToValidate(\'EditView\', \'case_number\', \'int\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_NUMBER','module' => 'Cases'), $this); echo '\' );
addToValidate(\'EditView\', \'type\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TYPE','module' => 'Cases'), $this); echo '\' );
addToValidate(\'EditView\', \'status\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS','module' => 'Cases'), $this); echo '\' );
addToValidate(\'EditView\', \'priority\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PRIORITY','module' => 'Cases'), $this); echo '\' );
addToValidate(\'EditView\', \'resolution\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_RESOLUTION','module' => 'Cases'), $this); echo '\' );
addToValidate(\'EditView\', \'work_log\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_WORK_LOG','module' => 'Cases'), $this); echo '\' );
addToValidate(\'EditView\', \'account_name\', \'relate\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOUNT_NAME','module' => 'Cases'), $this); echo '\' );
addToValidate(\'EditView\', \'account_id\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOUNT_ID','module' => 'Cases'), $this); echo '\' );
addToValidate(\'EditView\', \'duedate_c\', \'date\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DUEDATE','module' => 'Cases'), $this); echo '\' );
addToValidate(\'EditView\', \'resolveddate_c\', \'date\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_RESOLVEDDATE','module' => 'Cases'), $this); echo '\' );
addToValidate(\'EditView\', \'jobnumber_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_JOBNUMBER','module' => 'Cases'), $this); echo '\' );
addToValidate(\'EditView\', \'contactname_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACTNAME','module' => 'Cases'), $this); echo '\' );
