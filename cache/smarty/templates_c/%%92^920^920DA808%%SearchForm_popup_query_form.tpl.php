<?php /* Smarty version 2.6.11, created on 2011-06-17 13:21:17
         compiled from cache/modules/Cases/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/Cases/SearchForm_popup_query_form.tpl', 4, false),array('function', 'math', 'cache/modules/Cases/SearchForm_popup_query_form.tpl', 5, false),array('function', 'sugar_translate', 'cache/modules/Cases/SearchForm_popup_query_form.tpl', 14, false),array('function', 'sugar_getimagepath', 'cache/modules/Cases/SearchForm_popup_query_form.tpl', 71, false),array('function', 'html_options', 'cache/modules/Cases/SearchForm_popup_query_form.tpl', 90, false),)), $this); ?>
...
<?php echo smarty_function_html_options(array('name' => 'status_advanced[]','options' => $this->_tpl_vars['fields']['status_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['status_advanced']['value']), $this);?>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<?php echo smarty_function_sugar_translate(array('label' => 'LBL_WORKGROUP','module' => 'Cases'), $this);?>

    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['workgroup_c_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['workgroup_c_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['workgroup_c_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['workgroup_c_advanced']['name']; ?>
' 
