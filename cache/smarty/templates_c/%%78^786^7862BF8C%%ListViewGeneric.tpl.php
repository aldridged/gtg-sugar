...
'>		 
			...
			<?php endif; ?>
			<?php if (! empty ( $this->_tpl_vars['quickViewLinks'] )): ?>
			<td width='2%' nowrap><?php if ($this->_tpl_vars['pageData']['access']['edit']): ?><a title='<?php echo $this->_tpl_vars['editLinkString']; ?>
