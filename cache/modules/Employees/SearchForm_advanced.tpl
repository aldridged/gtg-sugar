...
{html_options name='employee_status_advanced[]' options=$fields.employee_status_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.employee_status_advanced.value}
   	   	</td>
...
<input type='text' name='{$fields.title_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		{sugar_translate label='LBL_ANY_PHONE' module='Employees'}
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
<input type='text' name='{$fields.department_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		{sugar_translate label='LBL_ANY_EMAIL' module='Employees'}
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
<input type='text' name='{$fields.email_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		{sugar_translate label='LBL_ANY_ADDRESS' module='Employees'}
    	</td>
	<td  nowrap="nowrap" width='25%'>
