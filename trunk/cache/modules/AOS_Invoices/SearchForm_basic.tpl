...
<input type='text' name='{$fields.name_basic.name}' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			{sugar_translate label='LBL_BILLING_ADDRESS_CITY' module='AOS_Invoices'}
		</td>
...
<input type='text' name='{$fields.billing_address_city_basic.name}' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			{sugar_translate label='LBL_PHONE_OFFICE' module='AOS_Invoices'}
		</td>
...
<input type='text' name='{$fields.address_street_basic.name}' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		{sugar_translate label='LBL_CURRENT_USER_FILTER' module='AOS_Invoices'}
    	</td>
