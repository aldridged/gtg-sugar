...
{if strlen($fields.facility_c_basic.value) <= 0}
{assign var="value" value=$fields.facility_c_basic.default_value }
{else}
{assign var="value" value=$fields.facility_c_basic.value }
{/if}  
<input type='text' name='{$fields.facility_c_basic.name}' 
    id='{$fields.facility_c_basic.name}' size='30' 
    maxlength='255' 
    value='{$value}' title='' tabindex='' > 
   	   	</td>
	{counter assign=index}
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		{sugar_translate label='LBL_CURRENT_USER_FILTER' module='Project'}
    	</td>
