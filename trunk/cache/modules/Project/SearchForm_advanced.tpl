...
<input autocomplete="off" type="text" name="{$fields.estimated_start_date_advanced.name}" id="{$fields.estimated_start_date_advanced.name}" value="{$date_value}" title=''  tabindex='' size="11" maxlength="10">
<img border="0" src="{sugar_getimagepath file='jscalendar.gif'}" alt="{$APP.LBL_ENTER_DATE}" id="{$fields.estimated_start_date_advanced.name}_trigger" align="absmiddle" />
...
<input autocomplete="off" type="text" name="{$fields.estimated_end_date_advanced.name}" id="{$fields.estimated_end_date_advanced.name}" value="{$date_value}" title=''  tabindex='' size="11" maxlength="10">
<img border="0" src="{sugar_getimagepath file='jscalendar.gif'}" alt="{$APP.LBL_ENTER_DATE}" id="{$fields.estimated_end_date_advanced.name}_trigger" align="absmiddle" />
<script type="text/javascript">
Calendar.setup ({ldelim}
...
{if strlen($fields.facility_c_advanced.value) <= 0}
{assign var="value" value=$fields.facility_c_advanced.default_value }
{else}
{assign var="value" value=$fields.facility_c_advanced.value }
{/if}  
<input type='text' name='{$fields.facility_c_advanced.name}' 
    id='{$fields.facility_c_advanced.name}' size='30' 
    maxlength='255' 
    value='{$value}' title='' tabindex='' > 
   	   	</td>
...
{html_options name='priority_advanced[]' options=$fields.priority_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.priority_advanced.value}
   	   	</td>
	</tr>
<tr>
	<td colspan='20'>
