...
{html_options name='status_basic[]' options=$fields.status_basic.options size="6" style="width: 150px" multiple="1" selected=$fields.status_basic.value}
   	   	</td>
	{counter assign=index}
	{math equation="left % right"
   		  left=$index
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		{sugar_translate label='LBL_CURRENT_USER_FILTER' module='Cases'}
    	</td>
