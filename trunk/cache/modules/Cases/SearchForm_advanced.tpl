...
{if strlen($fields.workgroup_c_advanced.value) <= 0}
{assign var="value" value=$fields.workgroup_c_advanced.default_value }
{else}
{assign var="value" value=$fields.workgroup_c_advanced.value }
{/if}  
<input type='text' name='{$fields.workgroup_c_advanced.name}' 
    id='{$fields.workgroup_c_advanced.name}' size='30' 
    maxlength='255' 
    value='{$value}' title='' tabindex='' > 
   	   	</td>
