...
<tr valign="middle">
<td nowrap>
<input autocomplete="off" type="text" id="{$fields.date_due.name}_date" value="{$fields[$fields.date_due.name].value}" size="11" maxlength="10" title='' tabindex="102" onblur="combo_{$fields.date_due.name}.update(); ">
<img border="0" src="{sugar_getimagepath file='jscalendar.gif'}" alt="{$APP.LBL_ENTER_DATE}" id="{$fields.date_due.name}_trigger" align="absmiddle">&nbsp;
</td>
<td nowrap>
...
<tr valign="middle">
<td nowrap>
<input autocomplete="off" type="text" id="{$fields.date_start.name}_date" value="{$fields[$fields.date_start.name].value}" size="11" maxlength="10" title='' tabindex="104" onblur="combo_{$fields.date_start.name}.update(); ">
...
<script type="text/javascript">
addToValidate('form_SubpanelQuickCreate_Tasks', 'id', 'id', false,'{/literal}{sugar_translate label='LBL_ID' module='Tasks'}{literal}' );
addToValidate('form_SubpanelQuickCreate_Tasks', 'name', 'name', true,'{/literal}{sugar_translate label='LBL_SUBJECT' module='Tasks'}{literal}' );
...
addToValidate('form_SubpanelQuickCreate_Tasks', 'modified_user_id', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_MODIFIED' module='Tasks'}{literal}' );
addToValidate('form_SubpanelQuickCreate_Tasks', 'modified_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_MODIFIED_NAME' module='Tasks'}{literal}' );
addToValidate('form_SubpanelQuickCreate_Tasks', 'created_by', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_CREATED' module='Tasks'}{literal}' );
addToValidate('form_SubpanelQuickCreate_Tasks', 'created_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CREATED' module='Tasks'}{literal}' );
addToValidate('form_SubpanelQuickCreate_Tasks', 'description', 'text', false,'{/literal}{sugar_translate label='LBL_DESCRIPTION' module='Tasks'}{literal}' );
addToValidate('form_SubpanelQuickCreate_Tasks', 'deleted', 'bool', false,'{/literal}{sugar_translate label='LBL_DELETED' module='Tasks'}{literal}' );
addToValidate('form_SubpanelQuickCreate_Tasks', 'assigned_user_id', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_ID' module='Tasks'}{literal}' );
addToValidate('form_SubpanelQuickCreate_Tasks', 'assigned_user_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='Tasks'}{literal}' );
addToValidate('form_SubpanelQuickCreate_Tasks', 'status', 'enum', true,'{/literal}{sugar_translate label='LBL_STATUS' module='Tasks'}{literal}' );
addToValidate('form_SubpanelQuickCreate_Tasks', 'date_due_flag', 'bool', false,'{/literal}{sugar_translate label='LBL_DATE_DUE_FLAG' module='Tasks'}{literal}' );
...
addToValidate('form_SubpanelQuickCreate_Tasks', 'date_start_flag', 'bool', false,'{/literal}{sugar_translate label='LBL_DATE_START_FLAG' module='Tasks'}{literal}' );
addToValidate('form_SubpanelQuickCreate_Tasks', 'date_start_date', 'date', false,'Start Date' );
addToValidateDateBefore('form_SubpanelQuickCreate_Tasks', 'date_start', 'datetimecombo', false,'{/literal}{sugar_translate label='LBL_START_DATE' module='Tasks'}{literal}', 'date_due' );
addToValidate('form_SubpanelQuickCreate_Tasks', 'parent_type', 'parent_type', false,'{/literal}{sugar_translate label='LBL_PARENT_NAME' module='Tasks'}{literal}' );
addToValidate('form_SubpanelQuickCreate_Tasks', 'parent_name', 'parent', false,'{/literal}{sugar_translate label='LBL_LIST_RELATED_TO' module='Tasks'}{literal}' );
addToValidate('form_SubpanelQuickCreate_Tasks', 'parent_id', 'id', false,'{/literal}{sugar_translate label='LBL_PARENT_ID' module='Tasks'}{literal}' );
addToValidate('form_SubpanelQuickCreate_Tasks', 'contact_id', 'id', false,'{/literal}{sugar_translate label='LBL_CONTACT_ID' module='Tasks'}{literal}' );
addToValidate('form_SubpanelQuickCreate_Tasks', 'contact_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CONTACT_NAME' module='Tasks'}{literal}' );
addToValidate('form_SubpanelQuickCreate_Tasks', 'contact_phone', 'phone', false,'{/literal}{sugar_translate label='LBL_CONTACT_PHONE' module='Tasks'}{literal}' );
addToValidate('form_SubpanelQuickCreate_Tasks', 'contact_email', 'varchar', false,'{/literal}{sugar_translate label='LBL_EMAIL_ADDRESS' module='Tasks'}{literal}' );
addToValidate('form_SubpanelQuickCreate_Tasks', 'priority', 'enum', true,'{/literal}{sugar_translate label='LBL_PRIORITY' module='Tasks'}{literal}' );
addToValidateBinaryDependency('form_SubpanelQuickCreate_Tasks', 'assigned_user_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Tasks'}{literal}: {/literal}{sugar_translate label='LBL_ASSIGNED_TO' module='Tasks'}{literal}', 'assigned_user_id' );
addToValidateBinaryDependency('form_SubpanelQuickCreate_Tasks', 'contact_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Tasks'}{literal}: {/literal}{sugar_translate label='LBL_CONTACT_NAME' module='Tasks'}{literal}', 'contact_id' );
