...
" class="button primary" onclick="fill_invitees();document.forms['EditView'].action.value='Save'; document.forms['EditView'].return_action.value='DetailView'; <?php if (isset ( $_REQUEST['isDuplicate'] ) && $_REQUEST['isDuplicate'] == 'true'): ?>document.forms['EditView'].return_id.value=''; <?php endif; ?>formSubmitCheck();;" type="button" name="button" value="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
">
...
" class="button" onclick="document.forms['EditView'].send_invites.value='1';fill_invitees();document.forms['EditView'].action.value='Save';document.forms['EditView'].return_action.value='EditView';document.forms['EditView'].return_module.value='<?php echo $_REQUEST['return_module']; ?>
...
function formSubmitCheck(){if(check_form('EditView') && isValidDuration()){document.forms['EditView'].submit();}}</script>
...
addToValidate(\'EditView\', \'modified_user_id\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED','module' => 'Calls'), $this); echo '\' );
...
addToValidate(\'EditView\', \'created_by\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'Calls'), $this); echo '\' );
