<?php /* Smarty version 2.6.11, created on 2011-05-06 11:18:33
         compiled from cache/modules/AOS_Quotes/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/AOS_Quotes/SearchForm_popup_query_form.tpl', 4, false),array('function', 'math', 'cache/modules/AOS_Quotes/SearchForm_popup_query_form.tpl', 5, false),array('function', 'sugar_translate', 'cache/modules/AOS_Quotes/SearchForm_popup_query_form.tpl', 14, false),array('function', 'html_options', 'cache/modules/AOS_Quotes/SearchForm_popup_query_form.tpl', 248, false),array('function', 'sugar_getimagepath', 'cache/modules/AOS_Quotes/SearchForm_popup_query_form.tpl', 422, false),)), $this); ?>
...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'AOS_Quotes'), $this);?>
...
' title='' tabindex='' > 
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ANY_ADDRESS','module' => 'AOS_Quotes'), $this);?>
...
' title='' tabindex='' > 
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ANY_PHONE','module' => 'AOS_Quotes'), $this);?>
...
' title='' tabindex='' > 
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<?php echo smarty_function_sugar_translate(array('label' => 'LBL_WEBSITE','module' => 'AOS_Quotes'), $this);?>
...
' size='30' 
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CITY','module' => 'AOS_Quotes'), $this);?>
...
' title='' tabindex='' > 
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ANY_EMAIL','module' => 'AOS_Quotes'), $this);?>
...
' title='' tabindex='' > 
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ANNUAL_REVENUE','module' => 'AOS_Quotes'), $this);?>

		</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['annual_revenue_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['annual_revenue_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['annual_revenue_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['annual_revenue_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['annual_revenue_advanced']['name']; ?>
' size='30' 
    maxlength='100' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title='' tabindex='' > 
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<?php echo smarty_function_sugar_translate(array('label' => 'LBL_STATE','module' => 'AOS_Quotes'), $this);?>
...
' title='' tabindex='' > 
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<?php echo smarty_function_sugar_translate(array('label' => 'LBL_EMPLOYEES','module' => 'AOS_Quotes'), $this);?>

		</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['employees_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['employees_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['employees_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['employees_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['employees_advanced']['name']; ?>
' size='30' 
    maxlength='10' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title='' tabindex='' > 
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<?php echo smarty_function_sugar_translate(array('label' => 'LBL_INDUSTRY','module' => 'AOS_Quotes'), $this);?>
...
<?php echo smarty_function_html_options(array('name' => 'industry_advanced[]','options' => $this->_tpl_vars['fields']['industry_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['industry_advanced']['value']), $this);?>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<?php echo smarty_function_sugar_translate(array('label' => 'LBL_POSTAL_CODE','module' => 'AOS_Quotes'), $this);?>
...
' title='' tabindex='' > 
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<?php echo smarty_function_sugar_translate(array('label' => 'LBL_TICKER_SYMBOL','module' => 'AOS_Quotes'), $this);?>

		</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['ticker_symbol_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['ticker_symbol_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['ticker_symbol_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['ticker_symbol_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['ticker_symbol_advanced']['name']; ?>
' size='30' 
    maxlength='10' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title='' tabindex='' > 
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<?php echo smarty_function_sugar_translate(array('label' => 'LBL_TYPE','module' => 'AOS_Quotes'), $this);?>

		</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php echo smarty_function_html_options(array('name' => 'aos_quotes_type_advanced[]','options' => $this->_tpl_vars['fields']['aos_quotes_type_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['aos_quotes_type_advanced']['value']), $this);?>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<?php echo smarty_function_sugar_translate(array('label' => 'LBL_COUNTRY','module' => 'AOS_Quotes'), $this);?>
...
' title='' tabindex='' > 
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<?php echo smarty_function_sugar_translate(array('label' => 'LBL_RATING','module' => 'AOS_Quotes'), $this);?>

		</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['rating_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['rating_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['rating_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['rating_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['rating_advanced']['name']; ?>
' size='30' 
    maxlength='100' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title='' tabindex='' > 
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'AOS_Quotes'), $this);?>
...
<?php echo smarty_function_html_options(array('name' => 'assigned_user_id_advanced[]','options' => $this->_tpl_vars['fields']['assigned_user_id_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['assigned_user_id_advanced']['value']), $this);?>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<?php echo smarty_function_sugar_translate(array('label' => 'LBL_OWNERSHIP','module' => 'AOS_Quotes'), $this);?>

		</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['ownership_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['ownership_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['ownership_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['ownership_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['ownership_advanced']['name']; ?>
' size='30' 
    maxlength='100' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title='' tabindex='' > 
