<?php /* Smarty version 2.6.11, created on 2011-05-12 16:31:49
         compiled from cache/modules/Employees/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Employees/EditView.tpl', 36, false),array('function', 'counter', 'cache/modules/Employees/EditView.tpl', 41, false),array('function', 'sugar_translate', 'cache/modules/Employees/EditView.tpl', 46, false),array('modifier', 'default', 'cache/modules/Employees/EditView.tpl', 42, false),array('modifier', 'strip_semicolon', 'cache/modules/Employees/EditView.tpl', 48, false),)), $this); ?>
...
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_KEY']; ?>
" class="button" onclick="window.location.href='index.php?action=index&module=Employees'; return false;" type="button" name="button" value="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
...
<?php if ($this->_tpl_vars['EDIT_REPORTS_TO']): ?><input tabindex="103"  type="text" name="<?php echo $this->_tpl_vars['fields']['title']['name']; ?>
...
<input tabindex="103"  type="hidden" name="<?php echo $this->_tpl_vars['fields']['title']['name']; ?>
" id="<?php echo $this->_tpl_vars['fields']['title']['name']; ?>
...
<?php if ($this->_tpl_vars['EDIT_REPORTS_TO']): ?><input tabindex="105"  type="text" name="<?php echo $this->_tpl_vars['fields']['department']['name']; ?>
...
<input tabindex="105"  type="hidden" name="<?php echo $this->_tpl_vars['fields']['department']['name']; ?>
" id="<?php echo $this->_tpl_vars['fields']['department']['name']; ?>
...
<?php if ($this->_tpl_vars['EDIT_REPORTS_TO']): ?><input tabindex="107"  type="text" name="<?php echo $this->_tpl_vars['fields']['reports_to_name']['name']; ?>
...
<input tabindex="107"  type="hidden" name="<?php echo $this->_tpl_vars['fields']['reports_to_id']['name']; ?>
...
, "single", true);'><img src="themes/default/images/id-ff-select.png?s=6f529a54aebb0a43443edb49141ea870&c=1"></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['reports_to_name']['name']; ?>
...
"><img src="themes/default/images/id-ff-clear.png?s=6f529a54aebb0a43443edb49141ea870&c=1"></button></span><?php else:  echo $this->_tpl_vars['fields']['reports_to_name']['value']; ?>
<input tabindex="107"  type="hidden" name="<?php echo $this->_tpl_vars['fields']['reports_to_id']['name']; ?>
" id="<?php echo $this->_tpl_vars['fields']['reports_to_id']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['reports_to_id']['value']; ?>
"><?php endif; ?>
...
addToValidate(\'EditView\', \'system_generated_password\', \'bool\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SYSTEM_GENERATED_PASSWORD','module' => 'Employees'), $this); echo '\' );
...
addToValidate(\'EditView\', \'external_auth_only\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_EXT_AUTHENTICATE','module' => 'Employees'), $this); echo '\' );
...
addToValidate(\'EditView\', \'phone_home\', \'phone\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_HOME_PHONE','module' => 'Employees'), $this); echo '\' );
addToValidate(\'EditView\', \'phone_mobile\', \'phone\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MOBILE_PHONE','module' => 'Employees'), $this); echo '\' );
addToValidate(\'EditView\', \'phone_work\', \'phone\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_WORK_PHONE','module' => 'Employees'), $this); echo '\' );
addToValidate(\'EditView\', \'phone_other\', \'phone\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_OTHER_PHONE','module' => 'Employees'), $this); echo '\' );
addToValidate(\'EditView\', \'phone_fax\', \'phone\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FAX_PHONE','module' => 'Employees'), $this); echo '\' );
...
addToValidate(\'EditView\', \'deleted\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DELETED','module' => 'Employees'), $this); echo '\' );
addToValidate(\'EditView\', \'portal_only\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PORTAL_ONLY_USER','module' => 'Employees'), $this); echo '\' );
...
addToValidate(\'EditView\', \'is_group\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_GROUP_USER','module' => 'Employees'), $this); echo '\' );
