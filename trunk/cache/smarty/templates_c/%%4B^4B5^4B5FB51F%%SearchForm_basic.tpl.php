<?php /* Smarty version 2.6.11, created on 2011-05-17 13:22:15
         compiled from cache/modules/Project/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/Project/SearchForm_basic.tpl', 6, false),array('function', 'math', 'cache/modules/Project/SearchForm_basic.tpl', 7, false),array('function', 'sugar_translate', 'cache/modules/Project/SearchForm_basic.tpl', 16, false),array('function', 'sugar_getimagepath', 'cache/modules/Project/SearchForm_basic.tpl', 99, false),array('modifier', 'count', 'cache/modules/Project/SearchForm_basic.tpl', 86, false),)), $this); ?>
...
<?php if (strlen ( $this->_tpl_vars['fields']['facility_c_basic']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['facility_c_basic']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['facility_c_basic']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['facility_c_basic']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['facility_c_basic']['name']; ?>
' size='30' 
    maxlength='255' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title='' tabindex='' > 
...
value="1" title='' tabindex="" <?php echo $this->_tpl_vars['checked']; ?>
 >
    ...
    <?php if (count($this->_tpl_vars['formData']) >= $this->_tpl_vars['templateMeta']['maxColumns']+1): ?>
    </tr>
    <tr>
...
'/>
	    ...
	    &nbsp;&nbsp;<a onclick="SUGAR.searchForm.searchFormSelect('<?php echo $this->_tpl_vars['module']; ?>
|advanced_search','<?php echo $this->_tpl_vars['module']; ?>
|basic_search')" href="#"><?php echo $this->_tpl_vars['APP']['LNK_ADVANCED_SEARCH']; ?>
</a>
	    <?php endif; ?>
    </td>
	<td style="text-align: right" width="*"><img  border='0' src='<?php echo smarty_function_sugar_getimagepath(array('file' => "help-dashlet.gif"), $this);?>
