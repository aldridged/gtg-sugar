...
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'modules/SugarFeed/Dashlets/SugarFeedDashlet/UserPostForm.tpl', 55, false),)), $this); ?>
...
' style="display:none;"><?php echo $this->_tpl_vars['less_img']; ?>
      ...
      <td style="padding-right: 5px;"><input id="text" name="text" type="text" size='25' maxlength='100' value="<?php echo $this->_tpl_vars['LBL_IS']; ?>
 " /></td>
      <td nowrap="nowrap">
      <input type="button" value="<?php echo $this->_tpl_vars['LBL_POST']; ?>
