<?php /* Smarty version 2.6.11, created on 2011-05-16 10:44:05
...
<table class="subMenuTD" style="padding: 8px; border: 2px solid #999; background-color: #fff;" cellpadding="0" cellspacing="2" border="0" align="center" width="440">
	...
	<tr>
		<td colspan="2" width="100%" style="font-size: 12px; padding-bottom: 5px;">
			...
			<br><br>
			<slot><select tabindex='3' name='timezone'><?php echo $this->_tpl_vars['TIMEZONEOPTIONS']; ?>
</select></slot>
...
"
  ...
  " ><br />
			<span class="dateFormat"><?php echo $this->_tpl_vars['MOD']['LBL_DST_INSTRUCTIONS']; ?>
</span>
		</td>
	</tr>
</table>
