<?php /* Smarty version 2.6.11, created on 2011-04-06 09:03:06
         compiled from modules/ModuleBuilder/tpls/listView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'modules/ModuleBuilder/tpls/listView.tpl', 65, false),array('function', 'counter', 'modules/ModuleBuilder/tpls/listView.tpl', 73, false),array('function', 'math', 'modules/ModuleBuilder/tpls/listView.tpl', 77, false),array('function', 'sugar_getimagepath', 'modules/ModuleBuilder/tpls/listView.tpl', 102, false),array('modifier', 'substr', 'modules/ModuleBuilder/tpls/listView.tpl', 104, false),)), $this); ?>
...
width').innerHTML;
					<?php endif; ?>
					ModuleBuilder.getContent('module=ModuleBuilder&action=editProperty&view_module=<?php echo $this->_tpl_vars['view_module']; ?>
'+
							'<?php if (isset ( $this->_tpl_vars['subpanel'] )): ?>&subpanel=<?php echo $this->_tpl_vars['subpanel'];  endif; ?>'+
							'<?php if ($this->_tpl_vars['MB']): ?>&MB=<?php echo $this->_tpl_vars['MB']; ?>
&view_package=<?php echo $this->_tpl_vars['view_package'];  endif; ?>'+
							'&id_label=subslot<?php echo $this->_tpl_vars['modCounter']; ?>
label'+
							'&name_label=label_'+
							  '<?php if (isset ( $this->_tpl_vars['value']['label'] )):  echo $this->_tpl_vars['value']['label']; ?>
'+
							  '<?php elseif (! empty ( $this->_tpl_vars['value']['vname'] )):  echo $this->_tpl_vars['value']['vname']; ?>
'+
							  '<?php else:  echo $this->_tpl_vars['key'];  endif; ?>'+
