...
//	d1.id="maincodeid" + ln ;
	...
	y.innerHTML="<input type='text' name='qty_product_qty[]' id='qty_product_qty" + ln + "' size='20' maxlength='6' value='' title='' tabindex='3' onblur='Quantity_formatNumber(" + ln + ");calculateProductLine(" + ln + ");'><input type='hidden' name='product_qty[]' id='product_qty" + ln + "' size='10' value='' title='' tabindex='3'>";
	z.innerHTML="<input type='text' name='product_name[]' id='product_name" + ln +"' size='15' maxlength='50' value='' title='' tabindex='3'><input type='hidden' name='product_id[]' id='product_id" + ln + "' size='20' maxlength='50' value=''>&nbsp;<input title='" + selectButtonTitle + "' accessKey='" + selectButtonKey + "' type='button' tabindex='3' class='button' value='" + selectButtonValue + "' name='btn1' onclick='openProductPopup(" + ln + ");'>";
	a.innerHTML="<input type='text' name='product_list_price[]' id='product_list_price" + ln + "' size='20' maxlength='50' value='' title='' tabindex='3' readonly='readonly'><input type='hidden' name='product_cost_price[]' id='product_cost_price" + ln + "' value=''  />";
	b.innerHTML="<input type='text' name='product_unit_price[]' id='product_unit_price" + ln + "' size='20' maxlength='50' value='' title='' tabindex='3' onfocus='copyListPrice(" + ln + ");' onblur='calculateProductLine(" + ln + ");'>";
	c1.innerHTML="<input type='text' name='vat_amt[]' id='vat_amt" + ln + "' size='20' maxlength='250' value='' title='' tabindex='3' readonly='readonly'>";
	
	c.innerHTML="<input type='text' name='product_total_price[]' id='product_total_price" + ln + "' size='20' maxlength='50' value='' title='' tabindex='3' readonly='readonly'>";
