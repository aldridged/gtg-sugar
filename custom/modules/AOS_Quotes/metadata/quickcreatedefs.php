      ...
      array (
        ...
        array (
          ...
          array (
            ...
            'customCode' => '<input type="text" tabindex="6" title="" value="{$fields.shipping_amount.value}" onBlur="calculateGrandTotal();" maxlength="16" size="30" id="shipping_amount" name="shipping_amount">',
          ),
        ),
        5 => 
        array (
